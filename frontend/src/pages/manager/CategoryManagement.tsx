    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <p className={styles.subtitle}>Tổ chức và quản lý các danh mục bài viết</p>
        </div>
            ...
            <table className={styles.table}>
              <thead>
                <tr>
                  ...
                  <th>Mô tả</th>
                  <th onClick={() => handleSort('parentId')} className={styles.sortable}>
                    Danh mục cha
                    {sortConfig?.key === 'parentId' && <i className={`bi bi-arrow-${sortConfig.direction === 'asc' ? 'up' : 'down'}`}></i>}
                  </th>
              ...
              <tbody>
                {paginatedCategories.map((category, index) => (
                  <tr key={category.id} className={styles.tableRow}>
                    ...
                    <td>{category.parentName || <span className={styles.noParent}>-</span>}</td>
                    <td>
