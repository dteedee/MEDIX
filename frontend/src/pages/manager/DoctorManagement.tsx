...
import { DoctorQuery, DoctorRegisterProfileDetails, DoctorRegisterProfileList } from '../../types/doctor.types';
...
export default function DoctorProfileList() {
    const [pageLoading, setPageLoading] = useState(true);
    const [profileList, setProfileList] = useState<DoctorRegisterProfileList>();
    ...
    const [doctorProfileDetails, setDoctorProfileDetails] = useState<DoctorRegisterProfileDetails>();
    ...
    const tabContents = [allDoctorsTabContent, pendingTabContent];
                        ...
                        <div className={styles.modalBody}>
                            <div className={styles.doctorDetails}>
                                <div className={styles.doctorInfo}>
                                    ...
                                    {doctorProfileDetails.dob && <p><strong>Ngày sinh:</strong> {new Date(doctorProfileDetails.dob).toLocaleDateString()}</p>}
                                    {doctorProfileDetails.gender && <p><strong>Giới tính:</strong> {getGenderLabel(doctorProfileDetails.gender)}</p>}
