    ...
    <form onSubmit={handleSubmit} className={styles.form}>
      <div className={styles.formContent}>
        ...
        <div className={styles.formGroup}>
          ...
          {!isReadOnly && (
            <span className={styles.helpText}>
              Mã sẽ tự động chuyển thành chữ hoa và thay khoảng trắng bằng dấu gạch dưới. {formData.code.length}/50 ký tự
            </span>
          )}
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          {!isReadOnly && (
            <span className={styles.helpText}>{formData.name.length}/200 ký tự</span>
          )}
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          {!isReadOnly && (
            <span className={styles.helpText}>
              Mô tả chi tiết sẽ giúp người dùng hiểu rõ hơn về chuyên khoa này. {formData.description.length}/1000 ký tự
            </span>
          )}
        </div>
        ...
        <div className={styles.formGroup}>
          <label className={styles.label}>
            ...
            Ảnh chuyên khoa {mode === 'create' && <span className={styles.required}>*</span>}
          </label>
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.toggleContainer}>
              ...
              <p className={styles.helpText}>
                {formData.isActive 
                  ? 'Chuyên khoa sẽ hiển thị cho người dùng và bác sĩ có thể đăng ký' 
                  : 'Chuyên khoa sẽ không hiển thị cho đến khi được kích hoạt'}
              </p>
            </div>
          </div>
        )}
