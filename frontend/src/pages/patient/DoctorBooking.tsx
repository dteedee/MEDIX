  ...
  const [basicDoctors] = useState<Doctor[]>([
    {
      ...
      rating: 4.5,
      reviewCount: 45,
      workplace: 'Phòng khám Đa khoa',
      price: 50000,
      tier: 'Basic',
      features: 'Tư vấn sức khỏe tổng quát, khám bệnh cơ bản'
    },
    {
      id: '2',
      ...
      rating: 4.6,
      reviewCount: 38,
      workplace: 'Phòng khám Da liễu',
      price: 50000,
      tier: 'Basic',
      features: 'Điều trị bệnh da liễu thường gặp'
    }
  ]);
  ...
  const [professionalDoctors] = useState<Doctor[]>([
    {
      ...
      price: 75000,
      tier: 'Professional',
      features: 'Khám bệnh nhi, tư vấn dinh dưỡng trẻ em'
    },
    {
      id: '4',
      ...
      price: 75000,
      tier: 'Professional',
      features: 'Điều trị bệnh tai mũi họng, phẫu thuật nhỏ'
    }
  ]);
  ...
  const [premiumDoctors] = useState<Doctor[]>([
    {
      ...
      rating: 4.9,
      reviewCount: 324,
      workplace: 'Viện Tim mạch Quốc gia',
      price: 100000,
      tier: 'Premium',
      features: 'Chuyên gia tim mạch hàng đầu, phẫu thuật tim'
    },
    {
      id: '6',
      ...
      rating: 5.0,
      reviewCount: 456,
      workplace: 'Bệnh viện K',
      price: 100000,
      tier: 'Premium',
      features: 'Chuyên gia ung thư, điều trị đa mô thức'
    }
  ]);
  ...
  const [vipDoctors] = useState<Doctor[]>([
    {
      ...
      rating: 5.0,
      reviewCount: 289,
      workplace: 'Bệnh viện 108',
      price: 150000,
      tier: 'VIP',
      features: 'Chuyên gia thần kinh hàng đầu, phẫu thuật não'
    },
    {
      id: '8',
      ...
      price: 150000,
      tier: 'VIP',
      features: 'Chuyên gia ngoại khoa quốc tế, phẫu thuật phức tạp'
    }
  ]);
